    ...
    <div className={classes.main}>
      <div className={classes.headerLinks}>
        <div className={classes.headerLinksColor}>
          <Button
            ...
            className={`${classes.buttonPadding} ${
              hotelSearch ? classes.buttonHeightMax : classes.buttonHeightMin
            }`}
            onClick={() => {
              if (!hotelSearch) {
          ...
          >
            <p className={`${hotelSearch ? classes.linkBackground : ""}`}>
              Հյուրանոցներ
            </p>
          </Button>
        </div>
        <div className={classes.headerLinksColor}>
          <Button
            className={`${classes.buttonPadding} ${
              viewSearch ? classes.buttonHeightMax : classes.buttonHeightMin
            }`}
            variant="success"
            onClick={() => {
              if (!viewSearch) {
          ...
          >
            <p className={`${viewSearch ? classes.linkBackground : ""}`}>
              Տեսարժան վայրեր
            </p>
          </Button>
        </div>
      ...
      {viewSearch &&
        viewList &&
        viewList.map((el) => <ViewResult key={idGenerator()} info={el} />)}
      {spinner && <Spinner />}
    </div>
  );
}
